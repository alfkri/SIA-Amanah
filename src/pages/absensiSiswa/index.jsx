...
const AbsensiSiswa = () => {
  const absensiData = [
    ...
    { tanggal: 9, status: "Hadir" },
    { tanggal: 10, status: "Sakit" },
    { tanggal: 11, status: "Hadir" },
    { tanggal: 12, status: "Hadir" },
    { tanggal: 13, status: "" },
    { tanggal: 14, status: "" },
    { tanggal: 15, status: "Sakit" },
    { tanggal: 16, status: "Hadir" },
    { tanggal: 17, status: "Hadir" },
    { tanggal: 18, status: "Alfa" },
    { tanggal: 19, status: "Hadir" },
    { tanggal: 20, status: "" },
    { tanggal: 21, status: "" },
    { tanggal: 22, status: "Hadir" },
    { tanggal: 23, status: "Hadir" },
    { tanggal: 24, status: "Hadir" },
    { tanggal: 25, status: "Hadir" },
    { tanggal: 26, status: "Hadir" },
    { tanggal: 27, status: "" },
    { tanggal: 28, status: "" },
    { tanggal: 29, status: "Hadir" },
    { tanggal: 30, status: "Sakit" },
    { tanggal: 31, status: "Izin" },
  ];
